...
public class CameraController {
     ...
     */
    public void RunQrCodeLoop(LinearOpMode opMode) throws InterruptedException {
    ...
    public void StartQRDetectThread(LinearOpMode opMode)
    {
        class QRThread extends Thread
        {
            ...
            {
                try {
                    RunQrCodeLoop(opMode);
                }
                catch (InterruptedException e)
                {
                    opMode.telemetry.addData("QRThread error", e);
                }
            }
        }
